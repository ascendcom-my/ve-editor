...
window.addEventListener('DOMContentLoaded', function () {
  ...
  toggleButton.addEventListener('click', function () {
    cover = !cover;
    window.localStorage.setItem('cover', cover);
    fit();
  });
});
...
module.exports = __webpack_require__(/*! /var/www/html/laravel/ve-editor/resources/js/fixed-ratio.js */"./resources/js/fixed-ratio.js");
